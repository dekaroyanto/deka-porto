  ...
  return (
    <div className="services" id="services">
      ...
      <div className="awesome">
        ...
        <span>
          I offer web development, marketplace management, data processing, and
          digital advertising
          <br />
          delivered efficiently and tailored to your needs.
        </span>
      ...
      <div className="cards">
        ...
        >
          <Card
            emoji={Glasses}
            heading={"Developer"}
            detail={"HTML, CSS, JavaScipt, ReactJs, Express"}
          />
        </motion.div>
        {/* 3rd */}
        <motion.div
